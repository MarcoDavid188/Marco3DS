...
INSERT INTO usuarios (nombre_completo, usuario, password, rol) VALUES  ('Administrador Principal', 'admin', 'admin123', 'Administrador'), 
('Cajero de Turno', 'cajero1', 'ventas2024', 'Cajero'); 
-- Insertar lote de inventario inicial 
INSERT INTO productos (nombre_producto, categoria, stock, precio) VALUES  ('Laptop Dell Inspiron 15', 'Computadoras', 10, 650.00), 
